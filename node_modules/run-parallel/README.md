...
![parallel](https://raw.githubusercontent.com/feross/run-parallel/master/img.webp) [![Sauce Test Status](https://saucelabs.com/browser-matrix/run-parallel.svg)](https://saucelabs.com/u/run-parallel)
